    ...
    <div className="app"
      ...
      <div className="app_calc">
        <div className="app_calc_navbar">
          <div className="app_calc_navbar_toggle" onClick={() => setIsDarkMode(!isDarkMode)}>
            <div className={`app_calc_navbar_toggle_circle ${isDarkMode ? "app_calc_navbar_toggle_circle_active" : ""}`} />
          </div>
